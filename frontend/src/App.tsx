...
export function AppContent(props: { 
  ...
  const [chatMessages, setChatMessages] = useState<Record<string, ChatMessage[]>>({
    "doc-1": [
      { id: "cm-1", sender: "ai", text: "Hello! I am MediDecode's Clinical Assistant. I have decoded Emily's prescription document for Seasonal Bronchitis. Ask me anything, e.g. 'How often should Amoxicillin be taken?' or 'Are there any allergies?'", timestamp: "10:15 AM" }
    ],
    "doc-2": [
  ...
  useEffect(() => {
    if ('serviceWorker' in navigator) {
      console.log('MediDecode PWA Service Worker Registered.');
    }
  }, []);
  ...
  const speakReportSummary = (forcePlayArg?: boolean | any) => {
    ...
    if (selectedLanguage === "te") {
      langCode = "te-IN";
      message = `రోగి ${patientName} కొరకు మెడిడికోడ్ ఏఐ నివేదిక సారాంశం.
...
డీకోడ్ చేయబడిన సారాంశం ఇలా ఉంది: ${summaryText}. తగిన జాగ్రత్తలు తీసుకోండి మరియు ఔషధాల ట్యాబ్ క్రింద షెడ్యూల్ చేయబడిన మందులను తనిఖీ చేయండి. వివరణను మ్యూట్ చేయడానికి దయచేసి స్పీకర్ బటన్‌ను మళ్లీ తాకండి.`;
      ...
      langCode = "hi-IN";
      message = `मरीज ${patientName} के लिए मेडीडिकोड एआई रिपोर्ट सारांश।
...
डीकोड की गई रूपरेखा दर्शाती है: ${summaryText}। उचित सावधानियां बरतें और दवाईयां टैब के अंतर्गत निर्धारित दवाओं की जांच करें। विवरण को बंद करने के लिए कृपया स्पीकर बटन को फिर से दबाएं।`;
      ...
      langCode = "en-US";
      message = `MediDecode AI Report Summary for patient ${patientName}.
    ...
    try {
      ...
      reader.onloadend = async () => {
        ...
        try {
          ...
          setUploadError("Neural system busy during vision call. Displaying beautiful pre-analyzed demo mock files so you can check how the MediDecode workspace decodes content.");
          setLoading(false);
...
<body>
  ...
  <div class="print-container">
    ...
    <div class="print-disclaimer-footer">
      <p style="font-style: italic; margin: 0 0 4px 0;">This report was generated by MediDecode AI.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <div className="p-1.5 rounded-lg bg-gradient-to-tr from-cyan-500 to-blue-600 text-white shadow-md shadow-cyan-500/25">
                <Brain className="w-5 h-5 animate-pulse" />
              </div>
              <span className="text-lg font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
                MediDecode AI
              </span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-12">
          ...
          <div className="max-w-2xl mx-auto space-y-4">
            ...
            <p className={`text-sm ${theme === "dark" ? "text-slate-400" : "text-slate-500"}`}>
              MediDecode translates unreadable handwriting and dry chemical markers into practical, patient-centric wellness actions.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-12 gap-8 text-left text-xs font-semibold">
          ...
          <div className="sm:col-span-4 space-y-3">
            ...
            <p className={`text-[10px] font-normal leading-relaxed ${theme === "dark" ? "text-slate-500" : "text-slate-400"}`}>
              MediDecode AI is a clinical educational information index. It does not replace advice, diagnoses, or prescriptions given by practicing hospital consultants or licensed clinical professionals.
            </p>
            <p className="text-[10px] text-slate-500 font-mono">© 2026 MediDecode AI. All rights private.</p>
          </div>
        ...
        <div id="prescription-print-section" className="hidden print:block bg-white text-slate-900">
          ...
          <div className="print-container">
            ...
            <div className="print-disclaimer-footer">
              <p style={{ fontStyle: "italic", margin: "0 0 4px 0" }}>This report was generated by MediDecode AI.</p>
